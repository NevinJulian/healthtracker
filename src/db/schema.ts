...
export const MIGRATIONS: Migration[] = [
  ...
  // v28: Correct recipe_library macro values to engine-computed per-ingredient data
  { version: 28, sql: `
  UPDATE recipe_library SET calories=512, protein=39, carbs=63, fat=11 WHERE id='r001';
  UPDATE recipe_library SET calories=576, protein=56, carbs=74, fat=7 WHERE id='r002';
  UPDATE recipe_library SET calories=486, protein=53, carbs=43, fat=11 WHERE id='r003';
  UPDATE recipe_library SET calories=563, protein=41, carbs=72, fat=12 WHERE id='r004';
  UPDATE recipe_library SET calories=472, protein=37, carbs=31, fat=22 WHERE id='r005';
  UPDATE recipe_library SET calories=320, protein=49, carbs=17, fat=6 WHERE id='r006';
  UPDATE recipe_library SET calories=483, protein=42, carbs=53, fat=12 WHERE id='r007';
  UPDATE recipe_library SET calories=600, protein=45, carbs=82, fat=10 WHERE id='r008';
  UPDATE recipe_library SET calories=413, protein=72, carbs=20, fat=5 WHERE id='r009';
  UPDATE recipe_library SET calories=472, protein=35, carbs=52, fat=14 WHERE id='r010';
  UPDATE recipe_library SET calories=497, protein=49, carbs=54, fat=10 WHERE id='r011';
  UPDATE recipe_library SET calories=306, protein=30, carbs=28, fat=8 WHERE id='r012';
  UPDATE recipe_library SET calories=400, protein=35, carbs=28, fat=16 WHERE id='r013';
  UPDATE recipe_library SET calories=587, protein=49, carbs=77, fat=9 WHERE id='r014';
  UPDATE recipe_library SET calories=577, protein=51, carbs=76, fat=8 WHERE id='r015';
  UPDATE recipe_library SET calories=473, protein=37, carbs=55, fat=12 WHERE id='r016';
  UPDATE recipe_library SET calories=567, protein=53, carbs=73, fat=7 WHERE id='r017';
  UPDATE recipe_library SET calories=360, protein=41, carbs=38, fat=5 WHERE id='r018';
  UPDATE recipe_library SET calories=589, protein=46, carbs=78, fat=11 WHERE id='r019';
  UPDATE recipe_library SET calories=371, protein=52, carbs=13, fat=13 WHERE id='r020';
  UPDATE recipe_library SET calories=574, protein=53, carbs=60, fat=13 WHERE id='r021';
  UPDATE recipe_library SET calories=455, protein=52, carbs=25, fat=17 WHERE id='r022';
  UPDATE recipe_library SET calories=343, protein=45, carbs=4, fat=16 WHERE id='r023';
  UPDATE recipe_library SET calories=272, protein=27, carbs=28, fat=6 WHERE id='r024';
  UPDATE recipe_library SET calories=409, protein=51, carbs=12, fat=17 WHERE id='r025';
  UPDATE recipe_library SET calories=416, protein=33, carbs=24, fat=21 WHERE id='r026';
  UPDATE recipe_library SET calories=719, protein=51, carbs=86, fat=19 WHERE id='r027';
  UPDATE recipe_library SET calories=457, protein=36, carbs=55, fat=10 WHERE id='r028';
  UPDATE recipe_library SET calories=681, protein=65, carbs=79, fat=12 WHERE id='r029';
  UPDATE recipe_library SET calories=532, protein=75, carbs=41, fat=7 WHERE id='r030';
  UPDATE recipe_library SET calories=418, protein=54, carbs=25, fat=11 WHERE id='r031';
  UPDATE recipe_library SET calories=473, protein=25, carbs=48, fat=20 WHERE id='r032';
  UPDATE recipe_library SET calories=365, protein=43, carbs=24, fat=11 WHERE id='r033';
  UPDATE recipe_library SET calories=339, protein=40, carbs=5, fat=18 WHERE id='r034';
  UPDATE recipe_library SET calories=421, protein=49, carbs=37, fat=9 WHERE id='r035';
  UPDATE recipe_library SET calories=489, protein=51, carbs=33, fat=17 WHERE id='r036';
  UPDATE recipe_library SET calories=568, protein=40, carbs=56, fat=21 WHERE id='r037';
  UPDATE recipe_library SET calories=660, protein=56, carbs=89, fat=9 WHERE id='r038';
  UPDATE recipe_library SET calories=338, protein=52, carbs=5, fat=12 WHERE id='r039';
  UPDATE recipe_library SET calories=374, protein=65, carbs=10, fat=8 WHERE id='r040';
  UPDATE recipe_library SET calories=466, protein=50, carbs=41, fat=12 WHERE id='r041';
  UPDATE recipe_library SET calories=620, protein=58, carbs=63, fat=15 WHERE id='r042';
  UPDATE recipe_library SET calories=481, protein=52, carbs=49, fat=9 WHERE id='r043';
  UPDATE recipe_library SET calories=538, protein=48, carbs=43, fat=19 WHERE id='r044';
  UPDATE recipe_library SET calories=726, protein=46, carbs=68, fat=30 WHERE id='r045';
  UPDATE recipe_library SET calories=339, protein=41, carbs=27, fat=7 WHERE id='r046';
  UPDATE recipe_library SET calories=564, protein=55, carbs=67, fat=8 WHERE id='r047';
  UPDATE recipe_library SET calories=419, protein=54, carbs=41, fat=4 WHERE id='r048';
  UPDATE recipe_library SET calories=436, protein=46, carbs=16, fat=21 WHERE id='r049';
  UPDATE recipe_library SET calories=627, protein=56, carbs=69, fat=14 WHERE id='r050';
  UPDATE recipe_library SET calories=609, protein=41, carbs=87, fat=11 WHERE id='r051';
  UPDATE recipe_library SET calories=726, protein=52, carbs=105, fat=11 WHERE id='r052';
  UPDATE recipe_library SET calories=675, protein=52, carbs=81, fat=16 WHERE id='r053';
  UPDATE recipe_library SET calories=304, protein=46, carbs=12, fat=8 WHERE id='r054';
  UPDATE recipe_library SET calories=294, protein=32, carbs=20, fat=9 WHERE id='r055';
  UPDATE recipe_library SET calories=466, protein=47, carbs=62, fat=4 WHERE id='r056';
  UPDATE recipe_library SET calories=395, protein=37, carbs=42, fat=9 WHERE id='r057';
  UPDATE recipe_library SET calories=383, protein=31, carbs=48, fat=8 WHERE id='r058';
  UPDATE recipe_library SET calories=395, protein=50, carbs=38, fat=5 WHERE id='r059';
  UPDATE recipe_library SET calories=379, protein=41, carbs=30, fat=11 WHERE id='r060';
  UPDATE recipe_library SET calories=592, protein=54, carbs=74, fat=9 WHERE id='r061';
  UPDATE recipe_library SET calories=541, protein=51, carbs=67, fat=8 WHERE id='r062';
  UPDATE recipe_library SET calories=247, protein=48, carbs=6, fat=3 WHERE id='r063';
  UPDATE recipe_library SET calories=284, protein=43, carbs=2, fat=11 WHERE id='r064';
  UPDATE recipe_library SET calories=500, protein=55, carbs=50, fat=9 WHERE id='r065';
  UPDATE recipe_library SET calories=392, protein=47, carbs=33, fat=8 WHERE id='r066';
  UPDATE recipe_library SET calories=312, protein=28, carbs=30, fat=9 WHERE id='r067';
  UPDATE recipe_library SET calories=279, protein=39, carbs=24, fat=3 WHERE id='r068';
  UPDATE recipe_library SET calories=456, protein=49, carbs=56, fat=4 WHERE id='r069';
  UPDATE recipe_library SET calories=280, protein=33, carbs=11, fat=12 WHERE id='r070';
  UPDATE recipe_library SET calories=603, protein=62, carbs=72, fat=7 WHERE id='r071';
  UPDATE recipe_library SET calories=578, protein=42, carbs=77, fat=11 WHERE id='r072';
  UPDATE recipe_library SET calories=364, protein=37, carbs=36, fat=8 WHERE id='r073';
  UPDATE recipe_library SET calories=349, protein=29, carbs=45, fat=6 WHERE id='r074';
  UPDATE recipe_library SET calories=472, protein=48, carbs=55, fat=7 WHERE id='r075';
  UPDATE recipe_library SET calories=311, protein=36, carbs=17, fat=11 WHERE id='r076';
  UPDATE recipe_library SET calories=579, protein=51, carbs=76, fat=8 WHERE id='r077';
  UPDATE recipe_library SET calories=316, protein=50, carbs=15, fat=6 WHERE id='r078';
  UPDATE recipe_library SET calories=132, protein=17, carbs=5, fat=5 WHERE id='r079';
  UPDATE recipe_library SET calories=223, protein=13, carbs=37, fat=3 WHERE id='r080';
  UPDATE recipe_library SET calories=126, protein=14, carbs=5, fat=6 WHERE id='r081';
  UPDATE recipe_library SET calories=117, protein=11, carbs=10, fat=4 WHERE id='r082';
  UPDATE recipe_library SET calories=203, protein=23, carbs=11, fat=7 WHERE id='r083';
  UPDATE recipe_library SET calories=86, protein=8, carbs=8, fat=2 WHERE id='r084';
  UPDATE recipe_library SET calories=173, protein=23, carbs=9, fat=5 WHERE id='r085';
  UPDATE recipe_library SET calories=144, protein=16, carbs=8, fat=5 WHERE id='r086';
  UPDATE recipe_library SET calories=191, protein=18, carbs=9, fat=10 WHERE id='r087';
  UPDATE recipe_library SET calories=96, protein=14, carbs=6, fat=2 WHERE id='r088';
  UPDATE recipe_library SET calories=131, protein=15, carbs=7, fat=5 WHERE id='r089';
  UPDATE recipe_library SET calories=67, protein=8, carbs=8, fat=0 WHERE id='r090';
  UPDATE recipe_library SET calories=110, protein=13, carbs=10, fat=2 WHERE id='r091';
  UPDATE recipe_library SET calories=107, protein=12, carbs=5, fat=5 WHERE id='r092';
  UPDATE recipe_library SET calories=158, protein=18, carbs=8, fat=6 WHERE id='r093';
  UPDATE recipe_library SET calories=71, protein=12, carbs=5, fat=0 WHERE id='r094';
  UPDATE recipe_library SET calories=78, protein=13, carbs=1, fat=2 WHERE id='r095';
  UPDATE recipe_library SET calories=104, protein=10, carbs=8, fat=4 WHERE id='r096';
  UPDATE recipe_library SET calories=170, protein=18, carbs=19, fat=2 WHERE id='r097';
  UPDATE recipe_library SET calories=251, protein=28, carbs=14, fat=9 WHERE id='r098';
